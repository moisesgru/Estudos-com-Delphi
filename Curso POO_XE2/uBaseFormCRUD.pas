...
uses
  ...
  System.Generics.Collections, Vcl.StdCtrls, Vcl.Buttons, Vcl.ImgList, Vcl.Grids, Vcl.DBGrids,
  Vcl.ActnList, Datasnap.DBClient, Vcl.Mask, Vcl.DBCtrls, MidasLib;
...
begin
  inherited;
  dsCrud.DataSet.Post;
  ClientDataSet1.SaveToFile('Teste.xml', dfXML);
end;
